...
- **Personalized feed** — listings ranked by cause match, age group, region, and remote availability
- **Explore** — browse 700+ teen-appropriate volunteer opportunities with cause and age filters
- **Log hours** — track volunteer hours by opportunity and organization
...
│   │   ├── Feed.jsx          # Personalized top-10 listings
...
The Databricks pipeline runs 4 notebooks in order:
